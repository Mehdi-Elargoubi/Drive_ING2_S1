...
public class Solveur {
	...
	*/
	...
	public Noeud algoAstar(Grille init) {
		...
		int min=myInf;
		double x = Math.pow(init.taille, init.taille)*Math.pow(init.taille, init.taille);
	...
	public static void main(String args[]) {
		Grille etatInitial = chargerFichier("C:/Users/Youssef/Desktop/_2022_2023_/2_IA/TP/puzzles/puzzle.txt");
