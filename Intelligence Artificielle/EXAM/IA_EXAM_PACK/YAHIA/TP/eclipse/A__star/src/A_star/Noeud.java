...
public class Noeud {
	...
	public Noeud(Grille grille, Noeud p, int g) {
		//this.grille.grille = new int[grille.taille][grille.taille];
		//this.grille.grille = grille.copier();
		//this.grille.taille = grille.taille;
		//this.grille.colone0 = grille.colone0;
		//this.grille.ligne0 = grille.ligne0;
		this.grille = new Grille(grille.grille);
		pere = p;
		this.g = g;
	}
