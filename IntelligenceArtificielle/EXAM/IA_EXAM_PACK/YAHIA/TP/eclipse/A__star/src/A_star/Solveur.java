	...
	*/
	...
	public Noeud algoAstar(Grille init) {
		...
		while(!liste_noeuds_ouverts.isEmpty() && !noeudCourant.estUnEtatFinal()) {
			...
			// n : noeud successeur
			// noeudIntermediaire : la reference du noeud 
			//successeurs qui existe dans la liste ouverte
			// noeudCourant : 
			for(Noeud n : liste_noeuds_courant_succ) {
				
				System.out.println("\n\n\n"+liste_noeuds_fermes+"\nsize = "+liste_noeuds_fermes.size()+"\n"+"\n\n\n");
				if(this.existe(liste_noeuds_fermes, n)!=null) {
